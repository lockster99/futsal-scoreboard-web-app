...
from model.db import db_connection, sqlite_connection
...
# @socketio.on('hidetimeticker', namespace="/courtA")
# def hide_time_ticker_A():
#     socketio.emit('hidetimer', namespace="/courtAticker")
#     socketio.emit('hidetimer', namespace="/alonetimerA")

# @socketio.on('hidetimeticker', namespace="/courtB")
# def hide_time_ticker_B():
#     socketio.emit('hidetimer', namespace="/courtBticker")
#     socketio.emit('hidetimer', namespace="/alonetimerB")


# for crt in ["A","B"]:
#     @socketio.on('hidetimeticker', namespace=f"/court{crt}")
#     def hide_time_ticker(crt):
#         socketio.emit('hidetimer', namespace=f"/court{crt}ticker")
#         socketio.emit('hidetimer', namespace=f"/alonetimer{crt}")
